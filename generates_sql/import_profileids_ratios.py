template = """drop table if exists profileids_bfsout;
create table profileids_bfsout_{} (
profileid integer primary key
);
copy profileids_bfsout from '/tmp/output_{}.txt';
...
for ratio in [("0.01", "1"), ("0.10", "10"), ("0.15", "15"), ("0.20", "20")]:
	print(template.format(ratio[1], ratio[0], ratio[1], ratio[1], ratio[1]))
