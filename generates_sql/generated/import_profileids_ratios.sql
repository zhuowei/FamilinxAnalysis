drop table if exists profileids_bfsout;
create table profileids_bfsout_1 (
profileid integer primary key
);
copy profileids_bfsout from '/tmp/output_0.01.txt';
...
copy profileids_bfsout from '/tmp/output_0.10.txt';
...
copy profileids_bfsout from '/tmp/output_0.15.txt';
...
copy profileids_bfsout from '/tmp/output_0.20.txt';
